...
function QuoteList() {
  ...
  if (searchParams.get("qtnstatus") !== null) {
    // && (qtnlistdatastatus === true)) {
    GetQuotationdetails(
      searchParams.get("qtnstatus"),
      searchParams.get("qtnformat")
    );
    //   setQtnListDataStatus(false);
  }
  ...
  return (
    <div>
      <h4 className="title">
        {" "}
        Quotation Manager: Quotation List - {searchParams.get(
          "qtnformat"
        )} - {searchParams.get("qtnstatus")}{" "}
      </h4>
      ...
      <div>
        <button
          className="button-style mb-1"
          style={{ float:'right' }}
          onClick={() => {
            // OldQtnId=${oldqtnid}&OldQtnNo=${quotationNo}&NewQtnNo=${""}&qtnformat=${searchParams.get("qtnformat")}&btn=Open`
            navigate(
              `/Quotation/FindQuoteOpen?OldQtnId=${selectedQuoteid}&OldQtnNo=${qtnno}&NewQtnNo=${""}&qtnformat=${qtnformat}&btn=Open`
            );
          }}
        >
          Open Quotation
        ...
        <button
          ...
          onClick={() => {
            navigate(
              `/Quotation/QuoteList?qtnliststat=${qtnliststatus}&qtnstatus=${qtnstatus}&qtnformat=${qtnformat}`
            );
          }}
        >
          Refresh
      ...
      <div className="row">
        ...
        >
          ...
          <Table
            ...
            style={{ marginLeft: "5px", border: "1px", whiteSpace:'nowrap' }}
          >
            ...
            <tbody
              className="tablebody"
              style={{ overflowY: "scroll", overFlowX: "scroll", whiteSpace:'nowrap' }}
            >
              {quotationListdata.length > 0 ? (
                quotationListdata.map((qtnlistdet, index) =>
            ...
            <div className="row">
              <div className="col-md-12">
                ...
                <input
                  type="text"
                  id="txtorderno"
                  onChange={(e) => setTxtOrderNo(e.target.value)}
                />
              </div>
            </div>
          </div>
            ...
            <div className="row">
              <div className="col-md-12">
                <label className="form-label">
                  Wish to mark as Order Received. Order No : {txtorderno}
                </label>
              </div>
            </div>
          </div>
